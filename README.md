...
This bar chart is showing the average amount calls per day of the week. Notice in the filters section it says ["Most Recent Month: True"](/Users/ajcarpinello/Desktop/Most Recent Month.png). This is limiting my graph to only collect data from the most recent month. To do this I created a calculated field that 
